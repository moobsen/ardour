...
PBD::DebugBits PBD::DEBUG::TransportFSMEvents = PBD::new_debug_bit ("transportfsmevents");
PBD::DebugBits PBD::DEBUG::TransportFSMState = PBD::new_debug_bit ("transportfsmstate");
